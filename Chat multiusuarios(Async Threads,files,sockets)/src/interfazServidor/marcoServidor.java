...
public class marcoServidor extends JFrame {
	...
	public marcoServidor() {
		try {
			 puertoRecibido=archivoBin.recibirServer();
		...
		textPuerto = new JTextField(puertoRecibido+"");
		...
		btnIniciar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					hiloServidor=new Thread (new hiloServidor(servidor,puerto,btnCerrar,btnIniciar,textPuerto));
					hiloServidor.start();
