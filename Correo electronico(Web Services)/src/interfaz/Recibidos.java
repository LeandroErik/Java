...
public class Recibidos extends JPanel {
	 ...
	 * Create the panel.
	 */
	public Recibidos(marcoCliente marco, Usuario user) {
		setLayout(null);
		
		JLabel lblMensajesEnviado = new JLabel("Mensajes Recibidos:");
		...
		try {
			msjs = msjdao.MsjRecibidos(user.getId());
		} catch (Exception e) {
