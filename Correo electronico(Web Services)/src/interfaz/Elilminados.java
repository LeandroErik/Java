...
public class Elilminados extends JPanel {
	 ...
	 * Create the panel.
	 */
	public Elilminados(marcoCliente marco, Usuario user) {
		setLayout(null);
		
		JLabel lblMensajesEnviado = new JLabel("Mensajes eliminados:");
		...
		try {
			msjs = msjdao.MsjEliminados(user.getId());
		} catch (Exception e) {
